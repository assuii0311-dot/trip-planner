...
export const CITIES = [
  ...
  { slug: 'montserrat', title: 'Montserrat', name: '몬세라트', nameEn: 'Montserrat', region: '카탈루냐', lat: 41.5931, lon: 1.8378, isHub: false, hub: 'barcelona', blurb: '톱니 모양 바위산 위의 베네딕도회 수도원.', transitGuide: walkable(['소년 합창단(에스콜라니아) 공연은 평일 13시입니다.', '산악열차와 케이블카 중 하나를 골라 왕복권을 삽니다.']) },
