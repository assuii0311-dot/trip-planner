 ...
 *
 *    이 값이 무엇을 세는지 한 번 어긋난 적이 있다 — 수집기가 위키백과가
 *    아닌 sitelink(커먼즈·위키보이지)까지 세어 볼거리의 24%가 한 칸씩
 *    부풀어 있었다. 수집기는 고쳤으나 **지금 `public/data/` 의 값은 아직
 *    옛 셈법**이다. 다시 수집할 때 기준선도 함께 다시 잰다
 *    (`docs/27-what-fame-counts.md`).
